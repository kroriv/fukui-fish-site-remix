    ...
    <main id={ "privacypolicy" }>
      <section>
        <div className={ "container content" }>
          ...
          <p className={ "!text-[80%] mb-4" }>株式会社〇〇〇〇(以下「当社」といいます。)は、個人情報(氏名、電子メールアドレス、電話番号、住所等個人を特定できる情報。以下「個人情報」といいます。)を重要なものと認識しております。</p>
      ...
      <section>
        <div className={ "container content" }>
          ...
          <ul className={ "list-decimal [padding-inline-start:22px] flex flex-col gap-4" }>
            ...
            <li className={ "!text-[80%]" }>当社は、養殖業管理事業を営んでおり、個人情報をご提供いただく際には利用目的をお知らせし、その利用目的の範囲内で利用し、利用目的の範囲を超えた個人情報の取扱い（以下「目的外利用」といいます。）を行わず、又そのための適切な措置を講じます。</li>
            ...
            <li className={ "!text-[80%]" }>当社は、従業者ならびに当社に加盟するフランチャイズ店に対する教育啓蒙活動を実施するほか、個人情報を取扱う部署ごとに管理責任者を置くとともに当社所定の管理基準に基づき、個人情報の適切な管理を行います。</li>
      ...
      <section>
        <div className={ "container content" }>
          <p className={ "!text-[80%] text-right" }>制定	平成17年 4月 1日</p>
          <p className={ "!text-[80%] text-right" }>株式会社〇〇〇〇</p>
          <p className={ "!text-[80%] text-right" }>代表取締役社長 〇〇〇〇</p>
        </div>
      </section>
    </main>
  );
